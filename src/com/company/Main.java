...
// !!! num.length !!! является вполне полноценным число, его можно использовать для указания размера другого массива
// или как пределе для него самого или иного, что добавляет множество интересных возможностей и безопасности!
public class Main {
